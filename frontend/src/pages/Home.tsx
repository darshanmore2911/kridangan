  ...
  return (
    <div data-testid="home-page" className="min-h-screen bg-[#070707] text-[#F5F5F5]">
      ...
      <main>
        <section data-testid="hero-section" className="relative isolate min-h-[720px] overflow-hidden border-b border-white/10 pt-28 sm:min-h-[780px] lg:pt-32">
          ...
          <div className="mx-auto grid max-w-7xl gap-16 px-5 pb-20 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-12 lg:px-10 lg:pb-28">
            <div className="relative z-10 max-w-2xl">
              <div data-testid="hero-eyebrow" className="mb-7 flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.2em] text-[#F97316]"><span className="h-px w-8 bg-[#F97316]" />{eventConfig.season} <span className="text-[#555]">/</span> {eventConfig.parentEvent} × {eventConfig.organizer}</div>
        ...
        <section id="about" data-testid="about-section" className="mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:px-10 lg:py-32"><div className="grid gap-14 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:gap-24"><div><p data-testid="about-eyebrow" className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#F97316]">05 / The campus</p><h2 data-testid="about-title" className="mt-4 font-heading text-3xl font-bold uppercase tracking-tight sm:text-4xl">Part of<br /><span className="text-[#666]">JamRang.</span></h2><p data-testid="about-copy" className="mt-8 max-w-xl text-lg leading-8 text-[#A1A1A1]">KRIDANGAN is part of the JamRang event ecosystem at Vijaybhoomi University, bringing esports into the wider campus celebration.</p><a data-testid="about-university-link" href="https://vijaybhoomi.edu.in/" target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex min-h-11 items-center gap-3 border-b border-[#F97316]/60 pb-2 font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-[#F5F5F5] transition-colors hover:text-[#F97316] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F97316]">Learn more about VU <ArrowUpRightIcon /></a></div><div data-testid="about-campus-card" className="relative overflow-hidden border border-white/10 bg-[#111111] p-7 sm:p-9"><div className="absolute right-0 top-0 size-32 bg-[#F97316]/10 blur-3xl" /><div className="relative"><div className="flex items-center gap-3"><span data-testid="about-jamrang-logo-image" className="flex h-12 w-24 items-center overflow-hidden rounded-sm bg-black"><img src={eventConfig.logoPaths.jamrang} alt="JamRang logo" className="h-full w-full object-contain" /></span><span data-testid="about-nxtgen-logo-crop" className="flex h-12 w-14 items-center justify-center overflow-hidden rounded-sm bg-black"><img src={eventConfig.logoPaths.nxtgen} alt="NxtGen Esports Club logo" className="h-full w-full scale-[3.5] object-contain object-center" /></span><span data-testid="about-university-logo-image" className="flex h-12 w-16 items-center justify-center overflow-hidden rounded-sm bg-white"><img src={eventConfig.logoPaths.university} alt="Vijaybhoomi University logo" className="h-full w-full object-contain" /></span></div><p data-testid="about-university-label" className="mt-9 font-mono text-[10px] uppercase tracking-[0.2em] text-[#F97316]">Vijaybhoomi University</p><p data-testid="about-location" className="mt-3 flex items-start gap-2 text-sm leading-6 text-[#A1A1A1]"><MapPin className="mt-1 size-4 shrink-0 text-[#F97316]" aria-hidden="true" />{eventConfig.venue}</p><p data-testid="about-logo-note" className="mt-8 border-t border-white/10 pt-4 font-mono text-[9px] uppercase tracking-[0.13em] text-[#555]">Official marks are now installed from the shared brand configuration</p></div></div></div></section>
