      ...
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10 lg:py-16">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr] md:gap-8">
          ...
          <div>
            ...
            <div data-testid="footer-network-value" className="mt-4 flex items-center gap-3"><img data-testid="footer-jamrang-logo-image" src={eventConfig.logoPaths.jamrang} alt="JamRang logo" className="h-10 w-20 rounded-sm object-contain" /><span className="text-[#555]">×</span><span data-testid="footer-nxtgen-logo-crop" className="flex h-10 w-12 items-center justify-center overflow-hidden rounded-sm bg-black"><img src={eventConfig.logoPaths.nxtgen} alt="NxtGen Esports Club logo" className="h-full w-full scale-[3.5] object-contain object-center" /></span><span className="text-[#555]">×</span><span data-testid="footer-university-logo-placeholder" className="flex size-10 items-center justify-center border border-white/15 bg-white/5 font-heading text-xs font-bold text-[#A1A1A1]">VU</span></div>
          </div>
          <div>
